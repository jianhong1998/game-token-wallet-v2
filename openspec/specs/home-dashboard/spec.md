...
The signed-in user's home/navigation shell: a Home dashboard listing the games they belong to, a persistent bottom nav across `(app)` routes, and an Account ("You") screen for identity and logout.
