...
export type Registry = {
  ...
  bump: number;
  activeGames: Array<Address>;
};

export type RegistryArgs = { bump: number; activeGames: Array<Address> };
...
export function getRegistryEncoder(): Encoder<RegistryArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["bump", getU8Encoder()],
      ["activeGames", getArrayEncoder(getAddressEncoder())],
    ]),
...
export function getRegistryDecoder(): Decoder<Registry> {
  return getStructDecoder([
    ...
    ["bump", getU8Decoder()],
    ["activeGames", getArrayDecoder(getAddressDecoder())],
  ]);
}
