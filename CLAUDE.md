...
It resolves lint/test/start commands from the `## Commands` section above — keep that section accurate as tooling changes, since an unresolved required command hard-stops the pipeline.
